...
public class ManagementController extends BaseController {
	...
	public @ResponseBody ResponseModel addChurchEvent(@RequestBody Event event) {
		log.info("Adding a  event :" + event.toString());
		String response = churchEventService.addEvent(event);
		if (null == response) {
